...
@Autonomous
public class BlueFrontRecycleTest extends LinearOpMode {
    private static final int SPINDLE_OPEN   = 140;
    private static final int SPINDLE_1BALL  = 40;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(45, 51, Math.toRadians(48)))
                        ...
                        .stopAndAdd(new BlueFront9Ball.PrimeLaunchers(launcherLeft, launcherRight, 2000))
                        .stopAndAdd(new BlueFront9Ball.Intake(intake, 0.4))
                        .strafeToLinearHeading(new Vector2d(30.5, 20), Math.toRadians(50))

                        .waitSeconds(.5)

                        .stopAndAdd(new BlueFront9Ball.Launch(spindle, 1))
                        .waitSeconds(.4)
                        .stopAndAdd(new BlueFront9Ball.Launch(spindle, 2))
                        .waitSeconds(.25)
                        .stopAndAdd(new BlueFront9Ball.Launch(spindle, 3))
                        .waitSeconds(0.5)
                        ...
                        .strafeToLinearHeading(new Vector2d(-13.5, 63), Math.toRadians(70))
                        .waitSeconds(.75)
                        ...
                        .afterTime(.75,new PrimeLaunchers(launcherLeft, launcherRight, 2100))
