...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2038.9050928622275; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -7295.206643931301; // x position of the perpendicular encoder (in tick units)
    }
