...
@Autonomous
public class BlueFront9Ball extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(45, 51, Math.toRadians(48)))
                        ...
                        .stopAndAdd(new PrimeLaunchers(launcherLeft, launcherRight, 2000))
                        ...
                        .afterTime(0, new Intake(intake,.4))
                        ...
                        .strafeToLinearHeading(new Vector2d(-15, 47.5), Math.toRadians(90))
                        .afterTime(0, new Intake(intake,.4))
                        .afterTime(0, new Spindle(spindle, 3))
                        .afterTime(.5,new PrimeLaunchers(launcherLeft, launcherRight, 2000))
                        .strafeToLinearHeading(new Vector2d(20, 20), Math.toRadians(45))
