...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1091.6791167036847; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2121.335851264189; // x position of the perpendicular encoder (in tick units)
    }
